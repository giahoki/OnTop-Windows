...
void RenderSettingsDialog(HWND hDlg) {
    ...
    DrawTextStyled(hMemDC, L"\u2699  Настройки", { 16, 0, w - 56, 40 }, COLOR_TEXT_PRIMARY, true, 13, DT_LEFT | DT_VCENTER | DT_SINGLELINE);
    ...
    DrawTextStyled(hMemDC, L"Быстрый ресайз", { 24, FAST_LABEL_Y, TRACK_R, FAST_CY - 4 }, COLOR_TEXT_PRIMARY, false, 13, DT_LEFT | DT_BOTTOM | DT_SINGLELINE);
    ...
    DrawTextStyled(hMemDC, L"Click-Through", { 24, CT_LABEL_Y, w - 24, CT_CY - 4 }, COLOR_TEXT_PRIMARY, false, 13, DT_LEFT | DT_BOTTOM | DT_SINGLELINE);
    ...
    for (int bi = 0; bi < 2; bi++) {
        ...
        DrawTextStyled(hMemDC, isOk ? L"OK" : L"Отмена", brc, isOk ? RGB(0,0,0) : COLOR_TEXT_PRIMARY, isOk, 13, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
    }
